...
export function ArchitecturalDetails({
  ...
  return (
    <group>
      ...
      <Box p={[5.04, 1.56, -5.9]} s={[7.12, 3.08, 0.035]} color={C.walnutDark} />
      {Array.from({ length: 45 }, (_, i) => (
        <Box
          key={i}
          p={[1.57 + i * 0.159, 1.55, -5.855]}
          s={[0.082, 3.04, 0.055]}
          color={i % 3 === 0 ? C.walnutLight : C.walnut}
          roughness={0.6}
        />
      ))}
      <GlowBar p={[5.07, 3.015, -5.76]} s={[6.92, 0.024, 0.025]} />
      <Box p={[5.04, 3.17, -5.95]} s={[7.27, 0.15, 0.21]} color={C.mullion} />
      <Box p={[8.63, 3.17, -3.27]} s={[0.13, 0.15, 5.53]} color={C.mullion} />
      <Box p={[8.63, 1.57, -0.59]} s={[0.12, 3.15, 0.12]} color={C.mullion} />
      <Box p={[5.02, 3.17, -0.59]} s={[7.28, 0.15, 0.13]} color={C.mullion} />
      <Box p={[1.43, 3.17, -3.27]} s={[0.13, 0.15, 5.53]} color={C.mullion} />
      <Box p={[1.43, 1.57, -0.59]} s={[0.1, 3.15, 0.1]} color={C.mullion} />
      {/* The suspended linear fixture sits inside the open roof, above the table. */}
      <Box p={[5.04, 3.17, -3.28]} s={[7.12, 0.07, 0.075]} color={C.mullion} />
      {[3.92, 6.12].map((x) => (
        <Cylinder key={x} p={[x, 2.98, -3.28]} radius={0.009} height={0.35} color={C.metalDeep} />
      ))}
      <Round p={[5.02, 2.78, -3.28]} s={[3.62, 0.095, 0.22]} color={C.walnutDark} radius={0.025} />
      ...
      {[2.4, 4.75, 7.1].map((x) => (
        <mesh key={x} position={[x, 1.17, -0.638]}>
          ...
          <meshBasicMaterial color={C.frost} transparent opacity={0.2} depthWrite={false} />
        </mesh>
      ))}
      <Cylinder p={[1.43, 1.25, -2.95]} radius={0.022} height={0.31} color={C.metal} />
      ...
      {desks.map((p, i) => {
        ...
        return (
          <group key={i} position={[p[0] + 0.92, 0.985, p[2] - 0.32]}>
            <Cylinder p={[0, 0.019, 0]} radius={0.12} height={0.038} color={C.metalDark} />
            <Cylinder p={[0, 0.23, 0]} radius={0.014} height={0.43} color={C.metal} />
            <Box p={[-0.075, 0.44, 0]} s={[0.18, 0.035, 0.035]} color={C.metal} metalness={0.6} />
            <mesh position={[-0.16, 0.4, 0]} castShadow>
              <coneGeometry args={[0.115, 0.12, 20, 1, true]} />
              <meshStandardMaterial
                color={i % 2 ? C.cushionSoft : C.accentDeep}
            ...
            {lit && (
              <>
                <GlowBar p={[-0.16, 0.343, 0]} s={[0.15, 0.012, 0.1]} />
      ...
      {[1, 3].map((index) => (
        <group key={index} position={[desks[index][0], 0.985, desks[index][2] - 0.34]}>
          <Round p={[0, 0.022, 0]} s={[0.37, 0.04, 0.25]} color={C.metalDark} radius={0.02} />
          <Box p={[0, 0.19, -0.055]} s={[0.065, 0.33, 0.055]} color={C.metalDark} />
          <Round p={[0, 0.48, -0.09]} s={[1.11, 0.64, 0.045]} color={C.screenFrame} radius={0.03} />
          <Box p={[0, 0.48, -0.06]} s={[1.02, 0.555, 0.014]} color={C.screen} />
          {[0, 1, 2, 3].map((i) => (
            <GlowBar
              key={i}
              p={[-0.25 + i * 0.165, 0.43 + (i % 3) * 0.055, -0.048]}
              s={[0.085, 0.13 + (i % 3) * 0.11, 0.005]}
              color={i % 2 ? C.screenLive : C.amberLit}
            />
          ))}
          <GlowBar p={[0, 0.69, -0.048]} s={[0.77, 0.018, 0.005]} color={C.screenLine} />
        </group>
      ))}
      {/* A warm floor lamp and side table finish the lounge silhouette. */}
      <group position={[7.57, 0, 4.95]}>
        <Cylinder p={[0, 0.035, 0]} radius={0.24} height={0.07} color={C.metalDark} />
        <Cylinder p={[0, 1.11, 0]} radius={0.027} height={2.14} color={C.metal} />
        <Box p={[-0.22, 2.19, 0]} s={[0.47, 0.035, 0.035]} color={C.metal} />
        <mesh position={[-0.43, 2.075, 0]} castShadow>
          <coneGeometry args={[0.3, 0.27, 24, 1, true]} />
          <meshStandardMaterial color={C.cushion} roughness={0.7} side={THREE.DoubleSide} />
        </mesh>
      ...
      <Cylinder p={[7.56, 0.32, 3.87]} radius={0.065} height={0.57} color={C.metal} />
      <Cylinder p={[7.56, 0.06, 3.87]} radius={0.22} height={0.055} color={C.metalDark} />
...
export function OperationsDisplay({ title = 'Office' }: { title?: string }) {
  ...
  return (
    <group position={[-5.68, 2.05, -5.79]}>
      <Round s={[3.85, 2.04, 0.1]} color={C.screenFrame} radius={0.045} />
      <mesh position={[0, 0, 0.057]}>
        <planeGeometry args={[3.65, 1.89]} />
        <meshBasicMaterial map={texture} toneMapped={false} />
      </mesh>
      <GlowBar p={[0, -1.075, -0.005]} s={[3.3, 0.018, 0.025]} color={C.screenLine} />
    </group>
  );
}
