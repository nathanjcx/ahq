...
import { Box, Cylinder, Halo, Round, SurfaceContext, type Point } from './office-primitives';
...
function Parquet() {
    ...
    for (let row = 0; row < 24; row++) {
      ...
      for (let col = 0; col < count; col++) {
        ...
        result.push({
          ...
          color: C.planks[(row * 7 + col * 5) % C.planks.length],
          width,
        });
        edge += width;
      }
  ...
  return (
    <group>
      ...
      <Box p={[0, -0.05, 6.015]} s={[18.1, 0.1, 0.045]} color={C.floorEdge} />
    </group>
  );
}
...
export function Architecture({
  ...
  return (
    <group>
      ...
      {[1.45, 8.58].map((x) => (
        <Box key={x} p={[x, 1.45, -0.65]} s={[0.055, 2.9, 0.055]} color={C.mullion} />
      ))}
      <Box p={[5.02, 2.91, -0.65]} s={[7.18, 0.065, 0.07]} color={C.mullion} />
      <Box p={[5.02, 0.035, -0.65]} s={[7.18, 0.045, 0.065]} color={C.mullion} />
      {[3.83, 6.2].map((x) => (
        <Box key={x} p={[x, 1.45, -0.65]} s={[0.043, 2.9, 0.045]} color={C.mullionSoft} />
      ))}
      ...
      <Box p={[1.45, 2.91, -3.25]} s={[0.065, 0.065, 5.25]} color={C.mullion} />
      <Box p={[1.45, 1.45, -4.55]} s={[0.05, 2.9, 0.055]} color={C.mullion} />
      ...
      <Box p={[1.45, 1.45, -3.24]} s={[0.05, 2.9, 0.045]} color={C.mullion} />
      {/* Open doorway on the near half of the left partition. */}
      <Round p={[5, 0.026, -3.28]} s={[6.4, 0.055, 4.5]} color={C.rug} radius={0.03} />
      <Round p={[5.1, 0.94, -3.3]} s={[3.65, 0.13, 1.53]} color={C.walnut} radius={0.19} />
      <Box p={[4.1, 0.46, -3.3]} s={[0.13, 0.87, 0.92]} color={C.walnutLight} />
      <Box p={[6.1, 0.46, -3.3]} s={[0.13, 0.87, 0.92]} color={C.walnutLight} />
      {[3.9, 5.1, 6.3].map((x) => (
        <group key={x}>
          <Chair p={[x, 0, -2.1]} color={C.seatSoft} />
          <Chair p={[x, 0, -4.5]} color={C.seatSoft} rotation={Math.PI} />
        </group>
      ))}
      <Laptop p={[4.12, 1.015, -3.2]} />
      <Laptop p={[6.08, 1.015, -3.4]} rotation={Math.PI} />
      <Box p={[5.25, 1.03, -3.3]} s={[0.48, 0.035, 0.6]} color={C.paper} rotation={[0, 0.18, 0]} />
      <Cylinder p={[5.26, 1.16, -3.65]} radius={0.07} height={0.29} color={C.cushion} />
      ...
      {[-1, 1].map((side) => (
        <Box key={side} p={[4.65, 0.073, 3.25 + side * 1.97]} s={[6.23, 0.009, 0.022]} color={C.rugEdge} />
      ))}
      <group position={[4.7, 0, 4.76]}>
        ...
        {[-1, 1].map((side) => (
          <group key={side}>
            <Round p={[side * 1.62, 0.72, -0.04]} s={[0.29, 0.66, 1.08]} color={C.sofa} radius={0.08} />
            <Round
              p={[side * 1.17, 0.94, 0.16]}
              s={[0.48, 0.47, 0.17]}
              color={side < 0 ? C.cushion : C.cushionSoft}
      ...
      {[2.5, 6.9].map((x, i) => (
        <group key={x} position={[x, 0, 1.75]} rotation={[0, i ? -0.25 : 0.25, 0]}>
          <Round p={[0, 0.43, 0]} s={[1.27, 0.55, 1.18]} color={C.seat} radius={0.11} />
          <Round p={[0, 0.93, -0.44]} s={[1.27, 0.73, 0.23]} color={C.sofa} radius={0.1} />
          <Round p={[0, 0.71, 0.06]} s={[0.95, 0.16, 0.92]} color={C.seatSoft} radius={0.07} />
          {[-1, 1].map((side) => (
            <Round
              key={side}
      ...
      <Round p={[4.7, 0.54, 3.18]} s={[2.32, 0.1, 1.15]} color={C.wood} radius={0.25} />
      {[-1, 1].map((side) => (
        <Box key={side} p={[4.7 + side * 0.75, 0.26, 3.18]} s={[0.12, 0.51, 0.65]} color={C.walnut} />
      ))}
      <Box p={[4.34, 0.61, 3.16]} s={[0.47, 0.05, 0.62]} color={C.seatSoft} rotation={[0, -0.17, 0]} />
      <Box p={[4.37, 0.655, 3.15]} s={[0.4, 0.025, 0.52]} color={C.paper} rotation={[0, -0.08, 0]} />
      <Cylinder p={[5.24, 0.67, 3.25]} radius={0.115} height={0.16} color={C.cushion} />
      <Plant position={[-8.15, 0, 5.15]} size={1.3} />
      <Plant position={[8.05, 0, -5.2]} size={1.4} />
      <Plant position={[8.15, 0, 4.95]} size={1.3} pot={C.potStone} />
      ...
      <group position={[-3.88, 2.34, -5.84]}>
        <mesh rotation={[Math.PI / 2, 0, 0]}>
          ...
          <meshStandardMaterial color={C.metalDeep} />
        </mesh>
