...
export function AnnouncePage({ state, update, notify, onEditGoal }: Common & { onEditGoal: () => void }) {
  ...
  function send() {
    ...
    update((s) => ({
      ...
      messages: [
        ...s.messages,
        { id: uid(), authorId: 'you', channel: 'announce', text, time: timeNow(), acknowledgmentIds: [] },
      ],
      events: [
        ...s.events,
        {
          id: uid(),
          text: 'A new announcement for the team',
          time: timeNow(),
          kind: 'announcement',
          source: 'local',
        },
    ...
    setMessage('');
    notify('Announcement saved. It will be included in new cloud assignments.');
  }
  return (
    ...
    <div className="settings-layout">
      <div className="settings-primary">
        ...
        <section className="surface settings-section">
          ...
          <p className="muted">
            Each employee works in their own cloud session through your organization’s Astra gateway.
          </p>
          {!window.ahq && (
      ...
      <aside>
        <section className="surface settings-section integrations">
          <div className="section-heading">
            <h2>
              <Link2 size={18} />
          ...
          <p className="muted">A home for the tools you already use.</p>
          {[
            {
              name: 'Calendar',
              description: 'A little awareness of your time',
              icon: CalendarDays,
              color: 'blue',
            },
            { name: 'Gmail', description: 'Thoughtful drafts, ready for review', icon: Send, color: 'red' },
            {
              name: 'Slack',
            ...
            {
              name: 'Project tools',
              description: 'Promises, wherever they start',
              icon: Flag,
              color: 'green',
            },
          ].map((item) => (
            <div className="integration" key={item.name}>
              <span className={`integration-icon ${item.color}`}>
                <item.icon size={21} />
              </span>
              <div>
          ...
          <div className="info-note">These connections are planned. No account access is active.</div>
        </section>
