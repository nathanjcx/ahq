export type Employee = {
  appearance?: import('../../shared/types').Appearance;
  sessionId?: string;
  activityLocation?: 'desk' | 'library' | 'meeting' | 'board';
  id: string;
  name: string;
  role: string;
  personality: string;
...
export type View =
  'Office' | 'Employees' | 'Announce' | 'Commitments' | 'Conversations' | 'Needs you' | 'Resources';
export const employees: Employee[] = [
  ...
  },
  {
    ...
    personality: 'Calm under pressure. Loves a good system and never lets an important promise slip.',
...
export const initialCommitments: Commitment[] = [
  {
    ...
    description: 'A clear story, a researched audience, and a plan everyone can work from.',
  ...
  },
  {
    ...
    description: 'Prepare a thoughtful weekly update with the progress that matters.',
    due: 'Friday, 12:00 PM',
    owner: 'noah',
    status: 'In progress',
    progress: 25,
  ...
  },
  {
    ...
    status: 'In progress',
    progress: 50,
    steps: ['Scan the market', 'Compare alternatives', 'Identify unmet needs', 'Prepare recommendations'],
  },
];
